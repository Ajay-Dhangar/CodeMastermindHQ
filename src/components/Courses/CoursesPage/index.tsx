        ...
        {filteredCourses.map((course, index) => (
          <article className="col col--6 margin-bottom--lg" key={index}>
            <a
              ...
              href={course.Url}>
              <img className="text--truncate cardTitle_node_modules-@docusaurus-theme-classic-lib-theme-DocCard-styles-module"
                src={course.imageUrl}
                alt={course.title}                
              />
              <div className="text--truncate cardTitle_node_modules-@docusaurus-theme-classic-lib-theme-DocCard-styles-module">
                <h2>{course.title}</h2>
                <p className="text--truncate cardDescription_node_modules-@docusaurus-theme-classic-lib-theme-DocCard-styles-module">{course.description}</p>
              </div>
            </a>
          </article>
        ))}
